          ...
          <form className="flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2 md:ml-auto md:mt-0">
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                minLength={3}
                placeholder="John"
                className="w-full px-4 py-2 mt-2 text-base leading-8 text-gray-700 border border-gray-300 rounded outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200"
              />
            </div>
