    ...
    <Layout>
      <div>
        ...
        <div className="mx-auto   ">
          <h1 className="text-lg text-center   my-4  py-4  bg-[#eba555] ">
            Migrants Pizzas
          </h1>
                    ...
                    <Link to={`/product/${item._id}`}>
                      <div className="overflow-hidden border rounded-lg border-opacity-60 ">
                        ...
                        <div className="p-6 border">
                          <h2 className="text-xs font-medium tracking-widest text">
                            {item.category}
                          </h2>
                          ...
                          <p className="text-lg font-medium tex-gray-900 title-font">
                            ${item.price}
                          </p>
                        </div>
                      </div>
